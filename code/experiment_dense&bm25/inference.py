...
def main():
    ...
    sys.argv += '''--model_name_or_path /opt/ml/input/custom_code/models/roberta-large-0512/
                --output_dir /opt/ml/input/custom_code/outputs/05121 --do_predict --dataset_name /opt/ml/input/data/test_dataset/
                '''.split()
    ...
    datasets = load_from_disk(data_args.dataset_name) # test dataset
    print(datasets)
    ...
    if data_args.eval_retrieval_sparse:
...
def run_dense_retrieval(
    ...
    context_path: str = "train_dataset",
) -> DatasetDict:
